        ...
        while (true) {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    System.out.print("Varian Rasa\t\t: "); // Tambah baris untuk mengambil varian rasa
                    String varianRasa = scanner.nextLine(); // Ambil varian rasa dari pengguna
                    if (jenis.equalsIgnoreCase("Basah")) {
                        System.out.print("\n\tJENIS KUE BASAH");
                        System.out.print("\n\t  TEKAN ENTER  ");
                        String jenisBasah = scanner.nextLine();
                        dbKue.tambahKue(new KueBasah(nama, harga, stok, jenisBasah, varianRasa)); // Ubah pemanggilan konstruktor
                    } else if (jenis.equalsIgnoreCase("Kering")) {
                        System.out.print("\n\tJENIS KUE KERING");
                        System.out.print("\n\t  TEKAN ENTER   ");
                        String jenisKering = scanner.nextLine();
                        dbKue.tambahKue(new KueKering(nama, harga, stok, jenisKering, varianRasa)); // Ubah pemanggilan konstruktor
                    } else {
                ...
                case 3:
                    ...
                    dbKue.updateKue(namaUpdate, hargaBaru, stokBaru, jenisBaru, varianRasaBaru); // Memanggil updateKue dengan jenis dan varian rasa baru
                    break;
                case 4:
                    System.out.println("\n====================================");
